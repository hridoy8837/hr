...
yt() {
    ...
    echo "${cyan}${bt} ••• YouTube Channel: Shadow Walker"
    echo "${cyan}${bt} ••• Join My Telegram Channel"
    echo "${cyan}${bt} ••• Telegram Channel: ShadowWalkerYT"
...
echo "${cyan}$bt • Telegram: ${yellow}https://t.me/ShadowWalkerYT"
...
echo "${white} 88 ${bt}${white}${rbg}SUBSCRIBE${reset}${bt}"
